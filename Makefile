...
pkgdatadir = $(datadir)/snort_ai_preproc
pkgincludedir = $(includedir)/snort_ai_preproc
pkglibdir = $(libdir)/snort_ai_preproc
pkglibexecdir = $(libexecdir)/snort_ai_preproc
...
STRIP = strip
VERSION = 0.1
abs_builddir = /home/wool/Code/Snort_AIPreproc
abs_srcdir = /home/wool/Code/Snort_AIPreproc
abs_top_builddir = /home/wool/Code/Snort_AIPreproc
abs_top_srcdir = /home/wool/Code/Snort_AIPreproc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
installdirs:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(corr_rulesdir)" "$(DESTDIR)$(sharedir)"; do \
